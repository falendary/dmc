...
init = function() {
  ...
  createIcons = function() {
    ...
    jQuery.each(mapBalloons, function(i, obj) {
      ...
      preview = '<div class="preview">' + '	<p>' + obj.shortname + '</p>' + '	<div class="row"><div class="item beds">' + obj.bedAlladult + '</div><div class="item beds">0</div></div>' + '	<div class="row"><div class="item">' + obj.neurosurgicalAdult + '</div><div class="item">0</div></div>' + '	<div class="row"><div class="item">' + obj.traumaAdult + '</div><div class="item">0</div></div>' + '	<div class="row"><div class="item">' + obj.bedAllkid + '</div><div class="item">0</div></div>' + '	<div class="row"><div class="item">' + obj.surgialAdult + '</div><div class="item">0</div></div>' + '	<div class="row"><div class="item">' + obj.tuberculousAdult + '</div><div class="item">0</div></div>' + '	<div class="row"><div class="item">' + obj.neurosurgicalAdult + '</div><div class="item">0</div></div>' + '	<div class="row"><div class="item">' + obj.neurosurgicalAdult + '</div><div class="item">0</div></div>' + '</div>';
