...
<div id="wrapper">
	...
	<div id="main">
		...
		<div class="holder-form">
            <form method="post" id="subsequent-form" action="" autocomplete="off" class="form {if !empty($EDITABLE) && $EDITABLE}enabled{else}disabled{/if}{if !empty($LOCKED)} locked{/if}">
				...
				<fieldset>
						...
						<div class="holder-triple">
							...
							<div class="triple">
								<div class="box-b-n">
									<div class="box">
										<div class="left">
											<label class="only">Направлено на амбулаторное лечение, всего</label>
										</div>
										<div class="right">
											<div class="holder-small">
									...
									<div class="box">
										<div class="left">
											<label class="only">Ожидающих госпитализацию, всего</label>
										</div>
										<div class="right">
											<div class="holder-small">
												<input type="number" min="0" placeholder="" name="pendingHospitalizationTotal" id="pendingHospitalizationTotal" value="{$REPORT.pendingHospitalizationTotal|default:0}" {if empty($EDITABLE)}disabled="disabled"{/if} />
												<label>из них детей</label>
												<input type="number" min="0" placeholder="" name="pendingHospitalizationChildren" id="pendingHospitalizationChildren" value="{$REPORT.pendingHospitalizationChildren|default:0}" {if empty($EDITABLE)}disabled="disabled"{/if} />
											</div>
										</div>
									</div>
								</div>
					...
					<div class="footer in-page">
						<div class="holder-nav-new">
							...
							{if empty($LOCKED)}
								{if !empty($CHECKING)}
									<button class="btn" type="submit" name="subsequentSubmit" value='doCheck'>проверить</button>
                                {elseif !empty($SIGNING)}
                                    <button class="btn" type="submit" name="subsequentSubmit" value='doSign'>утвердить</button>
                                {elseif !empty($EDITABLE)}
									<button class="btn" type="submit" name="subsequentSubmit" value='doSave'>сохранить</button>
								{/if}
								...
								<div class="holder-history">
									...
									<ul class="list-history">
										{foreach from=$ES_HISTORY.subsequent item=REP}
											<li {if $REP.subsequentReportID == $REPORT.subsequentReportID}class='active'{/if}>
                                                <span class="t1">
                                                ...
                                                <span class="t4">
                                                    ...
                                                    {/if}
                                                    {if $REP.subsequentReportID != $REPORT.subsequentReportID}<a class="next" href="/subsequent/{$REP.subsequentReportID}/"></a>{/if}
                                                </span>
											</li>
										{/foreach}
									</ul>
